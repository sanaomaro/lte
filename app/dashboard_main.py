...
from visualization import summarize_data, generate_charts
from modeling import detect_outliers, regression_analysis, predict_snr
...
#file_path = os.path.join("data", "train_telecom.csv")
